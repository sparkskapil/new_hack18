...
urlpatterns = [
    ...
    url(r'^Investor/Filter/',views.filter,name="Add Filter"),
    url(r'^Investor/ActivateFilter/',views.ActivateFilter,name="Activate Filter"),
    url(r'^Investor/logout/', views.inv_logout,name="investor logout"),
    
    url(r'^Startup/logout/', views.Startup_logout,name="startup logout"),
    url(r'^Startup/Edit/', views.Startup_Edit,name="startup edit"),
